                        ...
                        <div class="col-md-12 text-center">
                            ...
                            <div class="embed-responsive embed-responsive-16by9 mb-4">
                                <iframe class="embed-responsive-item"
                                    src="https://www.youtube.com/embed/eGUor824a74"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row box-body list-new-collection mb-5">
                        <div class="col-md-3 col-sm-6 col-12 mb-4">
                            <a href="" class="img-new-collection img-box-body">
                                <img src="assets/images/a-banh-nike-zoom-mercurial-vapor-15-academy-tf-dj5635-146-trang-xanh-1_16d876477ba945ff8659338ea6012fed_large.webp"
                                    alt="" />
                            </a>
                            <a href="" class="name-new-collection name-box-body text-dark text-justify">NIKE ZOOM
                                MERCURIAL VAPOR 15 ACADEMY TF - DJ5635-146 -
                                TRẮNG/XANH</a>
                            <span class="price-box-body d-block text-center text-danger">2.000.000đ</span>
                        </div>
                        <div class="col-md-3 col-sm-6 col-12 mb-4">
                            <a href="" class="img-new-collection img-box-body">
                                <img src="assets/images/giay-da-banh-adidas-x-speedportal-1-tf-gz2440-hong-den-1_cc7b137934774de683ee301feb05c3de_large.webp"
                                    alt="" />
                            </a>
                        ...
                        <div class="col-md-3 col-sm-6 col-12 mb-4">
                            <a href="" class="img-new-collection img-box-body">
                                <img src="assets/images/giay-da-banh-puma-future-ultimate-cage-1-4-tf-107174-01-xanh-cam-1_93f45529f0e44ae08a38aa048c92b888_large.webp"
                                    alt="" />
                            </a>
                        ...
                        <div class="col-md-3 col-sm-6 col-12 mb-4">
                            <a href="" class="img-new-collection img-box-body">
                                <img src="assets/images/giay-da-banh-mizuno-morelia-neo-iii-pro-as-p1gd228401-vang-den-1_e43c7d9aaab849d7ba7a963c9cc2be3e_large.webp"
                                    alt="" />
                            </a>
                        ...
                        <div class="col-md-12 text-center">
                            <nav class="d-inline-block mb-4">
                                <div class="nav nav-tabs">
                                    <a href="#tab-1" class="title-nav-tab nav-item nav-link active"
                                        data-toggle="tab">Giày sân cỏ nhân tạo</a>
                                    ...
                                    <div class="container">
                                        <div class="row box-body">
                                            <div class="col-md-3 col-sm-6 mb-4">
                                                ...
                                                <span
                                                    class="price-box-body d-block text-center text-danger">2.000.000đ</span>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-4">
                                                <a href="" class="img-box-body">
                                                    <img src="assets/images/a-banh-nike-zoom-mercurial-vapor-15-academy-tf-dj5635-146-trang-xanh-1_16d876477ba945ff8659338ea6012fed_large.webp"
